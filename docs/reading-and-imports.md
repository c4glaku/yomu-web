...
- **Reader:** choose **Scroll direction** in session setup, the reader toolbar, or settings. **Horizontal** scrolls left through vertical Japanese columns (top to bottom, then right to left); **Vertical** scrolls down through horizontal lines (left to right). The choice is remembered. Text PDFs and EPUBs reflow into either layout. Resume your page, jump to another page/chapter, and set a reading goal. Automatic scrolling and page turns run at 30–600 characters/minute (120 by default). Selecting text, manual scrolling, changing direction, opening a reader dialog, and switching away pause reading. Resume continues from your scroll position; direction and text-size changes keep your progress within the page.
